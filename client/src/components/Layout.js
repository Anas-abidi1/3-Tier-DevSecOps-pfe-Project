  ...
  return (
    <div className="app-layout">
      <header className="app-header slide-down">
        <div className="brand">
          <img src={logo} alt="SMART SKILLS logo" className="logo" />
          <div>
            <h1 className="brand-title">SMART SKILLS</h1>
            <p className="nav-subtitle">User Management</p>
          </div>
        </div>
      </header>
      <AnimatedBanner message="Welcome to SMART SKILLS 🚀" />
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} SMART SKILLS. All rights reserved.</p>
      </footer>
